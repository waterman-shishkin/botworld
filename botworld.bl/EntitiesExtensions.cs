namespace botworld.bl
{
	public static class EntitiesExtensions
	{
		...
		{
			return new EntityInfo(entity.Type, entity.HP, entity.AttackStrength, entity.DefenceStrength, entity.Location, entity.CanShareCell, entity.IsCollectable, entity is IPointsProvider ? ((IPointsProvider)entity).Points : 0);
		}
	}
}
