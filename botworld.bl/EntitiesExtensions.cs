namespace botworld.bl
{
	public static class EntitiesExtensions
	{
		...
		{
			return new EntityInfo(entity.Type, entity.HP, entity.AttackStrength, entity.AutoDamageStrength, entity.DefenseStrength, entity.Location, entity.CanShareCell, entity.IsCollectable, entity is IPointsProvider ? ((IPointsProvider)entity).WP : entity is IBot ? ((IBot)entity).WP : 0);
		}
	}
}
